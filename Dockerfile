...
#    Copyright (C) Ryan Siebert <ryansiebert@live.co.uk>
...
RUN cd /srv/mediagoblin.example.org/mediagoblin && echo '[[mediagoblin.media_types.raw_image]]' | sudo -u mediagoblin tee -a mediagoblin_local.ini
#
# HTML5 multi upload - +update all submit links
#
...
RUN sed -i s/"{{ request.urlgen('mediagoblin.submit.start') }}"/"\/html5-multi-upload"/ /srv/mediagoblin.example.org/mediagoblin/mediagoblin/templates/mediagoblin/base.html
#
#
#
